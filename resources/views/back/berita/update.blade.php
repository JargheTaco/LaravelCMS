        ...
        <form action="{{ url('berita/' .$berita->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="mt-1">
                    ...
                    <img src="{{ asset('storage/back/' . $berita->img) }}" class="img-thumbnail img-preview" width="100px">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <select name="status" id="status" class="form-control">
                            <option value="1" {{ $berita->status == 1 ? 'selected' : null }}>Published</option>
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        value="{{ old('publish_date', $berita->publish_date) }}">
                    </div>
                </div>
            </div>
