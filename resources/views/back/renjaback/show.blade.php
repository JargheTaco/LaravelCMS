...
@section('title', 'Detail Renja - Admin')
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mb-5">
    ...
    <div class="mt-3">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                    <div class="iframe-container">
                        <iframe src="https://docs.google.com/gview?url={{ urlencode($renja->pdf) }}&embedded=true" width="100%" height="500px" style="border: none;"></iframe>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <th>Publish Date</th>
                <td>: {{ $renja->publish_date }}</td>
            </tr>
        </table>

        <div class="float-end">
            <a href="{{ url('renjaback') }}" class="btn btn-secondary">Back</a>
        </div>
    </div>
    @endsection