...
@section('title', 'Detail Info Kegiatan - Admin')
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mb-5">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Detail Info Kegiatan</h1>
    ...
    <div class="mt-3">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                <th>Image</th>
                <td>
                    <a href="{{ $infokegiatan->img }}" target="_blank" rel="noopener noreferrer">
                    <img src="{{ $infokegiatan->img }}" alt="" width="50%">
                    </a>
                </td>
            </tr>
            <tr>
                <th>Views</th>
                <td>: {{ $infokegiatan->view }}x</td>
            </tr>
            <tr>
                <th>Status</th>
                @if ($infokegiatan->status == 1)
            ...
            <tr>
                <th>Publish Date</th>
                <td>: {{ $infokegiatan->publish_date }}</td>
            </tr>
        </table>

        <div class="float-end">
            <a href="{{ url('infokegiatan') }}" class="btn btn-secondary">Back</a>
        </div>
    </div>
    @endsection