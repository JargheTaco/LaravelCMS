...
@section('title', 'Detail Inovasi - Admin')
    ...
    <div class="mt-3">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                <th>Image</th>
                <td>
                    <a href="{{ $inovasi->img }}" target="_blank" rel="noopener noreferrer">
                    <img src="{{ $inovasi->img }}" alt="" width="50%">
                    </a>
                </td>
            </tr>
            <tr>
                <th>Views</th>
                <td>: {{ $inovasi->view }}x</td>
            </tr>
            <tr>
                <th>Status</th>
                @if ($inovasi->status == 1)
            ...
            <tr>
                <th>Publish Date</th>
                <td>: {{ $inovasi->publish_date }}</td>
            </tr>
        </table>

        <div class="float-end">
            <a href="{{ url('inovasiadmin') }}" class="btn btn-secondary">Back</a>
        </div>
    </div>
    @endsection