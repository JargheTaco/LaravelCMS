...
@section('title', 'Detail FAQ - Admin')
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mb-5">
    ...
    <div class="mt-3">
            ...
            <tr>
                ...
                <td>
                    <div class="iframe-container">
                        <iframe src="https://docs.google.com/gview?url={{ urlencode($faq->pdf) }}&embedded=true" width="100%" height="500px" style="border: none;"></iframe>
                    </div>
                </td>
            </tr>
        ...
        <div class="float-end">
            <a href="{{ url('faq') }}" class="btn btn-secondary">Back</a>
        </div>
    </div>
    @endsection