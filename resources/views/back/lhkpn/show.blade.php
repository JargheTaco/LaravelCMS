...
@section('title', 'Detail LHKPN - Admin')
    ...
    <div class="mt-3">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                <th>Image</th>
                <td>
                    <a href="{{ $lhkpn->img }}" target="_blank" rel="noopener noreferrer">
                    <img src="{{ $lhkpn->img }}" alt="" width="50%">
                    </a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th>Publish Date</th>
                <td>: {{ $lhkpn->publish_date }}</td>
            </tr>
        </table>

        <div class="float-end">
            <a href="{{ url('lhkpn') }}" class="btn btn-secondary">Back</a>
        </div>
    </div>
    @endsection