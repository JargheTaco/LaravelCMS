...
@section('title', 'Detail Sejarah - Admin')
    ...
    <div class="mt-3">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                <th>Image</th>
                <td>
                    <a href="{{ $sejarah->img }}" target="_blank" rel="noopener noreferrer">
                    <img src="{{ $sejarah->img }}" alt="" width="50%">
                    </a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th>Publish Date</th>
                <td>: {{ $sejarah->publish_date }}</td>
            </tr>
        </table>

        <div class="float-end">
            <a href="{{ url('sejarah') }}" class="btn btn-secondary">Back</a>
        </div>
    </div>
    @endsection