...
@section('title', 'Create Kebijakan Privasi - Admin')

@section('content')

<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Create Kebijakan Privasi</h1>
    ...
    <div class="mt-3">
        ...
        <form action="{{ url('kebijakanprivasi') }}" method="post" enctype="multipart/form-data">
            @csrf
