...
<div class="profile-card-container">
  @foreach($profilpejabat as $item)
    <div class="profile-card">
      ...
      <a href="#portfolio{{ $item->id }}" data-bs-toggle="modal" class="profile-btn">Lihat Profil</a>
    </div>
  @endforeach
</div>

@foreach($profilpejabat as $item)
<div class="portfolio-modal modal fade" id="portfolio{{ $item->id }}" tabindex="-1" role="dialog" aria-hidden="true">
